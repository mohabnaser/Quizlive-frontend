...
import {
    Zap, LayoutDashboard, BookOpen, Play, Users, BarChart3,
    Trophy, User, Settings, Bell, Plus, LogOut, CreditCard,
...
const navItems = [
    ...
    { icon: BookOpen, label: 'My Quizzes', to: '/dashboard/quizzes' },
    { icon: Play, label: 'Live Sessions', to: '/dashboard/sessions' },
    { icon: Users, label: 'Classes', to: '/dashboard/classes' },
    { icon: BarChart3, label: 'Analytics', to: '/dashboard/analytics' },
    { icon: Trophy, label: 'Leaderboard', to: '/dashboard/leaderboard', badge: 'NEW' },
        ...
        >
            {({ isActive }) => (
                <>
                    ...
                    {badge && (
                        <span className="text-[8px] font-bold tracking-wider bg-amber-500/20 text-amber-400 border border-amber-500/30 rounded-full px-1.5 py-0.5">
                            {badge}
                        </span>
                    )}
                </>
    ...
    return (
        ...
        >
            ...
            <nav className="flex-1 overflow-y-auto px-3 py-2 space-y-0.5">
                ...
                <button
                    onClick={() => navigate('/dashboard/quiz-builder')}
                    className="group flex w-full items-center gap-2.5 rounded-xl border border-dashed border-[#2A2A3D] px-3 py-2.5 text-sm font-medium text-[#64748B] transition-all duration-200 hover:border-[#7C3AED]/50 hover:text-[#C4B5FD] hover:bg-[rgba(124,58,237,0.06)] cursor-pointer"
                >
                    <Plus size={15} className="group-hover:text-[#A78BFA] transition-colors" />
                    New Quiz
                </button>
                ...
                <button
                    ...
                    className="group flex w-full items-center gap-2.5 rounded-xl border border-dashed border-[#2A2A3D] px-3 py-2.5 text-sm font-medium text-[#64748B] transition-all duration-200 hover:border-[#7C3AED]/50 hover:text-[#C4B5FD] hover:bg-[rgba(124,58,237,0.06)] cursor-pointer"
                >
                    <Sparkles size={15} className="group-hover:text-[#A78BFA] transition-colors" />
                    Explore Templates
                </button>
            ...
            <div className="border-t border-[#2A2A3D]/60 p-3 relative">
                ...
                >
                    ...
                    <div className="relative shrink-0">
                        <div className="h-9 w-9 rounded-full bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center ring-2 ring-amber-400/70 ring-offset-2 ring-offset-[#13131F]">
                    ...
                    <div className="flex-1 min-w-0 text-left">
                        <p className="text-[13px] font-semibold text-white truncate">Alex Teacher</p>
                        <p className="text-[11px] text-[#64748B] truncate">alex@school.edu</p>
                    </div>

                    <div className="flex items-center gap-1.5 shrink-0">
                        <span className="text-[9px] font-bold bg-gradient-to-r from-[#7C3AED] to-[#8B5CF6] text-white rounded-full px-1.5 py-0.5 tracking-wider">
                            PRO
                        </span>
                        <Settings
                            size={14}
                ...
                {popoverOpen && (
                    ...
                    >
                        {[
                            ...
                            { icon: CreditCard, label: 'Billing & Plan', to: '/dashboard/settings' },
